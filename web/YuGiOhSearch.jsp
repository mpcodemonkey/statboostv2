                            ...
                            <div class="tab-pane" id="advanced">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nameInput" placeholder="The name of the card">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="textInput">Card Text</label>
                                        <input type="text" class="form-control" id="textInput" placeholder="Ability or flavor text">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="scaleInput">Pendulum Scale</label>
                                        <input type="text" class="form-control" id="scaleInput" placeholder="For cards with a pendulum scale value">
                                    </div>
                                </div>
