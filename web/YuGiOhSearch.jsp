...
<div class="container">
    ...
    <div class="tabbed-search">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#simple" role="tab" data-toggle="tab">Simple Search</a></li>
            <li><a href="#advanced" role="tab" data-toggle="tab">Advanced Search</a></li>
        </ul>
        ...
        <div class="tab-content">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <form action="" method="post">
                            ...
                            <input name="r1" type="radio" id="monster"/>
                            <label>Monster</label>
                            <input name="r1" type="radio" id="spell"/>
                            <label>Spell</label>
                            <input name="r1" type="radio" id="trap"/>
                            <label>Trap</label>
                            <input checked name="r1" type="radio" id="all"/>
                            <label>All</label><br>
            ...
            <div class="tab-pane" id="advanced">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label" for="formInput1">Name</label>
                        <input type="text" class="form-control" id="formInput1" placeholder="Placeholder text">
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="formInput2">Card Text</label>
                        <input type="text" class="form-control" id="formInput2" placeholder="Placeholder text">
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="formInput3">Pendulum Effect</label>
                        <input type="text" class="form-control" id="formInput3" placeholder="Placeholder text">
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="formInput4">Pendulum Scale</label>
                        <input type="text" class="form-control" id="formInput4" placeholder="Placeholder text">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <label class="control-label" for="attrib">Attribute</label><br>
                        ...
                        <select class="form-control multiselect" multiple="multiple" id="attrib">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label" for="icon">Icon</label><br>
                        ...
                        <select class="form-control multiselect" multiple="multiple" id="icon">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label" for="monsterType">Monster Type</label><br>
                        ...
                        <select class="form-control multiselect" multiple="multiple" id="monsterType">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label" for="cardType">Card Type</label><br>
                        ...
                        <select class="form-control multiselect" multiple="multiple" id="cardType">
